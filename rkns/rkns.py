...
class RKNSBuilder:
    ...
    def from_existing_rkns_store(
        ...
        if rkns_header.get("version") != current_header["version"]:
            raise ValueError(
        ...
        if rkns_header.get("implementation") != current_header["implementation"]:
            warnings.warn(
                f"The RKNS file was generated by a different implementation ({rkns_header.get('implementation')}). "
